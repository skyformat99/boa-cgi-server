...
#line 1 "boa_grammar.y" /* yacc.c:339  */
...
static const char *const yytname[] =
{
  ...
  "$@2", "ExtensionList", "Extension", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 8:
#line 79 "boa_grammar.y" /* yacc.c:1646  */
...
#line 1275 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 87 "boa_grammar.y" /* yacc.c:1646  */
    { if ((yyvsp[-1].cval)->action) {
			DBG(printf("StmtOneArg: %s %s\n",(yyvsp[-1].cval)->name,(yyvsp[0].sval));)
...
#line 1291 "y.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 97 "boa_grammar.y" /* yacc.c:1646  */
    { if ((yyvsp[-3].cval)->action) {
			DBG(printf("StmtTwoArgs: '%s' '%s' '%s'\n",
			            (yyvsp[-3].cval)->name,arg1hold,(yyvsp[0].sval));)
			(yyvsp[-3].cval)->action((yyvsp[0].sval),arg1hold,(yyvsp[-3].cval)->object);
		  }
		  free(arg1hold);
		}
...
#line 126 "boa_grammar.y" /* yacc.c:1906  */
